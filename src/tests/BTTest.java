...
/** Note that in JAVA, methods can't be overmidden to be more private.
...
class BTDriver  implements GlobalConst
{
 ...
 private void menu() {
  ...
  protected void runAllTests (){
	...
	case 5:
	  keyType=AttrType.attrString;
	  System.out.println("Please input the S key to insert: ");
	  String Strkey=GetStuff.getStringChoice(); 
	 
	  pageno.pid=1;
	  mid=new MID(pageno, 1);              
	  file.insert(new StringKey(Strkey), mid);
	  break; 
	case 6:
